...
export default {
	...
	created() {
		// 获得相似用户信息
		console.log("Parameters passed in:" + this.$route.params)
		...
		console.log("Similar user ID:" + this.$route.params.uid)
		console.log("Name of similar user:" + this.name)
			...
			if (isLove === true) {
				...
				_addLoveSong({
					...
					if (response.data.code === 200) {
						...
						this.$message({
							type: "success",
							message: songName + " " + "Add to favorite!",
						})
					}
				})
			}
